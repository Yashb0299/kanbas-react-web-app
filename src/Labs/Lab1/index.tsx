        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Fruit Salad</li>
                    <li>Xinjiang big plate chicken</li>
                    <li>Braised spare ribs in brown sauce</li>
                    <li>Braised beef with potatoes</li>
                </ol>
            ...
            <div id="wd-images">
                ...
                <br/>
                <img id="wd-teslabot" src={"images/teslabot.png"} alt="Teslabot" height="200px"/>
            </div>
            <div id="wd-forms">
                <h4>Form Elements</h4>
                <form id="wd-text-fields">
                    ...
                    <input type="date"
                           ...
                           value="2000-01-21"/><br/>
                    <h4>Anchor tag</h4>
                    <a href={"https://github.com/Yashb0299/kanbas-react-web-app"}>Click Here</a><br/>
                </form>
            </div>
        </div>
    );

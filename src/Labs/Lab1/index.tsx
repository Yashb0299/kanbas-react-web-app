        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Add aesafoedita and other seed spices</li>
                    <li>Add boiled rice and mix well</li>
                    <li>Add spices and salt to flavour</li>
            ...
            <div id="wd-anchor-tag">
                ...
                <a id="wd-github" href="https://github.com/KartikJondhalekar/-kanbas-react-web-app">Github</a><br />
            </div>
        </div>
    );
}
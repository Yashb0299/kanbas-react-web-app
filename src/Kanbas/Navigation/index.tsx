...
export default function KanbasNavigation() {
    ...
    return (
        <div id="wd-kanbas-navigation" className="list-group rounded-0">
            <a id="wd-account-link" target="_blank" href={"https://www.northeastern.edu/"} className="list-group-item bg-black border-0" rel="noreferrer">
                <img src="/images/NEU_Logo.jpg" width="75px" alt="Northeastern Logo" />
            </a>
